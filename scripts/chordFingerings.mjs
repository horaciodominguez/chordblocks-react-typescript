...
function transposeShape(shape, rootIndex, targetIndex) {
  ...
  const frets = shape.frets.map((f) => (f == null || f === 0 ? f : f + semitones))
  let baseFret = shape.baseFret === 1 && frets.every((f) => f == null || f === 0 || f <= 4)
    ? 1
    : Math.min(
        ...frets.filter((f) => typeof f === "number" && f > 0),
      )
...
const E_BARRE = {
  "": { frets: [1, 3, 3, 2, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  m: { frets: [1, 3, 3, 1, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  5: { frets: [1, 3, 3, null, null, null], baseFret: 1, barre: { fret: 3, fromString: 5, toString: 4 } },
  6: { frets: [1, null, 3, 2, 3, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  m6: { frets: [1, null, 3, 1, 3, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  7: { frets: [1, 3, 1, 2, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  m7: { frets: [1, 3, 1, 1, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  maj7: { frets: [1, 3, 2, 2, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  dim: { frets: [1, 2, 3, 1, null, null], baseFret: 1 },
  dim7: { frets: [1, 2, 3, 1, 3, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  aug: { frets: [1, null, 3, 2, 2, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  m7b5: { frets: [1, null, 1, 1, 2, null], baseFret: 1 },
  9: { frets: [1, 3, 1, 2, 1, 3], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 2 } },
  m9: { frets: [1, 3, 1, 1, 1, 3], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 2 } },
  maj9: { frets: [1, null, 2, 2, 1, 3], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  add9: { frets: [1, 3, 3, 2, 1, 3], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 2 } },
  sus2: { frets: [1, 3, 3, null, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  sus4: { frets: [1, 3, 3, 3, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
  "7sus4": { frets: [1, 3, 1, 3, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 1 } },
}

/** A-shape barre templates at fret 1 (A#/Bb root on string 5). */
const A_BARRE = {
  "": { frets: [null, 1, 3, 3, 3, 1], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  m: { frets: [null, 1, 3, 3, 2, 1], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  5: { frets: [null, 1, 3, 3, null, null], baseFret: 1, barre: { fret: 3, fromString: 4, toString: 3 } },
  6: { frets: [null, 1, 3, 3, 3, 3], baseFret: 1, barre: { fret: 3, fromString: 4, toString: 1 } },
  m6: { frets: [null, 1, 3, 3, 2, 3], baseFret: 1 },
  7: { frets: [null, 1, 3, 1, 3, 1], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  m7: { frets: [null, 1, 3, 1, 2, 1], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  maj7: { frets: [null, 1, 3, 2, 3, 1], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  ...
  9: { frets: [null, 1, 3, 1, 3, 3], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  m9: { frets: [null, 1, 3, 1, 2, 3], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  maj9: { frets: [null, 1, 3, 2, 3, 3], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  add9: { frets: [null, 1, 3, 3, 3, 3], baseFret: 1, barre: { fret: 3, fromString: 4, toString: 1 } },
  sus2: { frets: [null, 1, 3, 3, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  sus4: { frets: [null, 1, 3, 3, 4, 1], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
  "7sus4": { frets: [null, 1, 3, 1, 4, 1], baseFret: 1, barre: { fret: 1, fromString: 5, toString: 1 } },
}
...
const OPEN_SHAPES = {
  ...
  Fmaj7: { frets: [1, 3, 2, 2, 1, 0], baseFret: 1, barre: { fret: 1, fromString: 6, toString: 2 } },
  ...
  Csus4: { frets: [null, 3, 3, 0, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 2, toString: 1 } },
  ...
  G5: { frets: [3, 5, 5, null, null, null], baseFret: 3, barre: { fret: 5, fromString: 5, toString: 4 } },
  ...
  // 7sus4
  C7sus4: { frets: [null, 3, 3, 3, 1, 1], baseFret: 1, barre: { fret: 1, fromString: 2, toString: 1 } },
...
function normalizeBaseFret(shape) {
  ...
  if (hasOpen && maxFret <= 4) {
    return { ...shape, frets: [...frets], baseFret: 1, ...(shape.barre ? { barre: { ...shape.barre } } : {}) }
  }
