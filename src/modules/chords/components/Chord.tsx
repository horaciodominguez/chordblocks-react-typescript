...
export default function Chord({ chord, asText = false }: Props) {
  ...
  return (
    <span className="flex flex-row items-end justify-center whitespace-nowrap">
      ...
      {suffix && (
        <span className="mb-0.5 text-center text-xs font-thin italic font-display text-zinc-200 light:text-zinc-800 guide:mb-0 guide:text-[length:var(--atril-chord-suffix,0.625rem)] guide:leading-none stage:text-white">
          {suffix}
        </span>
      )}
    </span>
