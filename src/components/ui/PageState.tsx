...
const linkClass =
  "inline-flex items-center justify-center min-h-11 px-4 rounded-sm border border-zinc-100/10 bg-indigo-800 text-sm font-semibold text-white hover:bg-indigo-700"

const secondaryLinkClass =
  "inline-flex items-center justify-center min-h-11 px-4 rounded-sm border border-zinc-100/10 bg-zinc-200/5 text-sm font-semibold text-white hover:bg-zinc-200/10"
