...
const variants: Record<PanelVariant, string> = {
  card: "border border-zinc-200/10 rounded-md bg-white/5 backdrop-blur-md p-6 shadow-md shadow-zinc-900/20",
  flat: "border border-zinc-700 rounded-md bg-zinc-50/5 p-4 shadow-md shadow-black/20 backdrop-blur-md",
}
    ...
    return (
      <div className={`relative self-start w-full ${className}`}>
        <div
          ...
          aria-hidden
        >
          <div className="w-full h-px bg-gradient-to-r from-indigo-700/0 from-30% via-red-600/100 via-65% to-indigo-900/0 to-90%" />
        </div>
